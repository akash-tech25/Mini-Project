...
@st.cache
def ld_enrol():
    enrolment = read_csv("gross-enrolment-ratio-from-2013-2016.csv",index_col=0)
    return enrolment

@st.cache
def ld_comps():
    comps=pd.read_csv("percentage-of-schools-with-computers-from-2013-2016.csv")
    return comps
...
@st.cache
def ld_gt():
    girls_toilet=pd.read_csv("schools-with-girls-toilet-from-2013-2016.csv")
    return girls_toilet
